...
| 2026-06-16 | **SUPERSEDED for EUR/USD — legal but illiquid** | Real Angel One data: NSE EUR/USD future ~92 lots/day, divergence from spot exceeds the edge's slippage headroom → no tradable vehicle. EUR/INR is liquid but its edge is marginal/fragile. The validated edge is now **BTC (+1.686R)**, not FX. **Action: disable the EUR/USD scanner.** See callouts above + [[Trading System#GATE 2b]]. |
